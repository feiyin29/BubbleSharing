        ...
        <v-col cols="12">
          ...
          <v-row no-gutters>
            ...
            <v-col cols="8">
                    ...
                    >
                      ...
                      >
                        <v-col cols="1"
                          ...
                          "
                        >
                          <img src="../assets/logoBlue.png" width="26.5" />
                        </v-col>
                        <v-col
                          class="
                            heading3-16
              ...
              <!-- end of account[0].themeTemplate = 0 -->
            </v-col>
            <v-col></v-col>
          </v-row>
        </v-col>
        ...
        <v-col cols="12">
          ...
          <v-row no-gutters>
            ...
            <v-col cols="8">
              ...
              <!-- end of account[0].themeTemplate = 1 -->
            </v-col>
            <v-col></v-col>
          </v-row>
        </v-col>
...
// bubble.sh/{{account[0].username}}
// const personalUrl = account[0].username
