  ...
  <v-container fluid class="pa-0">
    ...
    <v-row no-gutter>
      <v-col
        cols="12"
        style="height: 1024px"
        class="sheetStyle tw-bg-[#00C97B] tw-bg-[url('src/assets/home1.png')]"
      >
        <v-row no-gutter class="tw-pl-11">
          <v-col cols="7">
            ...
            <v-row no-gutter class="tw-py-16">
              <button
                class="Body3 tw-bg-[#FFDA52] hover:tw-bg-[#FCCD22] required tw-text-[#252525] tw-font-bold py-4 px-10 tw-rounded-full"
    ...
    <v-row no-gutter>
      <v-col
        cols="12"
        style="height: 1024px"
        class="sheetStyle tw-bg-[#FF6853] tw-bg-[url('src/assets/home2.png')]"
      >
        <v-row no-gutter>
          <v-col cols="6"></v-col>
          <v-col cols="6">
            ...
            <v-row no-gutter>
              <button
                class="tw-bg-[#BD8EDE] hover:tw-bg-[#B683DA] tw-hover:bg-blue-700 tw-text-[#F8F8F8] Heading1 tw-py-4 tw-px-8 mt-11 tw-rounded-full"
                @click="$router.push('/create')"
              >
                Get start for free
              </button>
